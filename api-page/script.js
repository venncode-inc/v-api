...
setTimeout(() => {
  ...
  setTimeout(() => {
    ...
    // Tampilkan modal WhatsApp kalau belum pernah ditutup
    if (localStorage.getItem('hideWaModal') !== 'true') {
    ...
    document.querySelector('.close-btn')?.addEventListener('click', () => {
      ...
      localStorage.setItem('hideWaModal', 'true');
    });
    ...
    document.querySelector('.join-btn')?.addEventListener('click', () => {
      window.open('https://whatsapp.com/channel/invite/xxxxxx', '_blank'); // ganti link kamu yaa
      document.getElementById('waModal').style.display = 'none';
      localStorage.setItem('hideWaModal', 'true');
    });
