...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const populatePageContent = () => {
        ...
        const creator = settings.apiSettings?.creator || 'HAZEL';

        setPageContent(DOM.pageTitle, settings.name, "HAZEL API");
        setPageContent(DOM.wm, `© ${currentYear} ZelApi's Corp. Semua hak dilindungi.`);
        setPageContent(DOM.appName, settings.name, "HAZEL API");
